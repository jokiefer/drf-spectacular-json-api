...
def pytest_collection_modifyitems(config, items):
    skip_missing_contrib = pytest.mark.skip(
        reason="skip tests for missing contrib package")
    allow_contrib_fail = pytest.mark.xfail(
        reason="contrib test were allowed to fail")
    for item in items:
...
@pytest.fixture()
def clear_caches():
    from drf_spectacular.plumbing import (get_openapi_type_mapping,
